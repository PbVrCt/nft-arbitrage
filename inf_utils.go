...
func ExtractAxieInfo(ax Axie) AxieInfo {
	...
	axie.Eyes_type = ax.Parts[0].Class
	axie.Ears_type = ax.Parts[1].Class
	axie.Back_type = ax.Parts[2].Class
	axie.Mouth_type = ax.Parts[3].Class
	axie.Horn_type = ax.Parts[4].Class
	axie.Tail_type = ax.Parts[5].Class
	return axie
}
