...
The nfts are from a popular "play to e4rn" game, called Ax1e 1nfinity. I don´t play this game but I have some friends that do, and they hyped me about the money flowing in and the amount of bots running the markets. I thought that this could be fun and we could make some money and set up to do an ML pipeline to flip the nfts. I did make some money but I found that the Pokemon-counterbalances nature of the game and the meta changes make it so that in order to be able to invest or do feature engineering to make a model you have to understand the idosynchracies of the gameplay and need to play the game. I did play briefly but to understand teh game better but I´m not into it. I found that the models that I got are not robust and often miss the mark hard and so I need a "human in the loop" to do the final trades in order to make money. I made some money along with my friends and I invited them to dinner but to make a living out of speculation is not somethign that i´m interested on.
